...
public class Processor {
    ...
    private int registerAddressDecoder(Word word) {
        ...
        return new Bit(true).and(fifthBit).and(fourthBit).and(thirdBit).and(secondBit).and(firstBit).getValue() ? 31
                : new Bit(true).and(fifthBit).and(fourthBit).and(thirdBit).and(secondBit).getValue() ? 30
                        : new Bit(true).and(fifthBit).and(fourthBit).and(thirdBit).and(firstBit).getValue() ? 29
                                : new Bit(true).and(fifthBit).and(fourthBit).and(thirdBit).getValue() ? 28
                                        : new Bit(true).and(fifthBit).and(fourthBit).and(secondBit).and(firstBit)
                                                .getValue()
                                                        ? 27
                                                        : new Bit(true).and(fifthBit).and(fourthBit).and(secondBit)
                                                                .getValue()
                                                                        ? 26
                                                                        : new Bit(true).and(fifthBit).and(fourthBit)
                                                                                .and(firstBit).getValue()
                                                                                        ? 25
                                                                                        : new Bit(true).and(fifthBit)
                                                                                                .and(fourthBit)
                                                                                                .getValue()
                                                                                                        ? 24
                                                                                                        : new Bit(true)
