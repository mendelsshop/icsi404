...
public class UnitTests {
    ...
    public void processor2() {
        ...
        MainMemory.load(new String[] {
                ...
                // r1 = 5
                "00000000000000010100000000100001",
                // 00000000 00000 00001 1111 00010 000 11
                // garbage r1(rs1)sub r2(rd)math2r
                // r2 = r0(0) - r1(5) = -5
                "00000000000000000111110001000011",
                // 0000000000000 00010 1111 00011 000 10
                // garbage r2(rs1)sub r3(rd)math2r
                // r3 = r2(-5) - r2(-5) = 0
                "00000000000000001011110001100010",
                // halt
                "00000000000000000000000000000000"
        });
        processor.run();
