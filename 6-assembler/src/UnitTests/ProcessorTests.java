...
public class ProcessorTests {
	...
	@Test
	public void decode() {
		System.out.println(Processor.getNBits(new Word(
				new Bit[] { getTrue(), getTrue(), getTrue(), getFalse(), getTrue(), getTrue(), getTrue(), getTrue(),
	...
	public void BasicLoadDestOnly() {
		ProcessorTestTemplate(new String[] {
				...
				"00000000000000000000000000000000", "11111111111111111111111111111000"
	...
	public void BasicLoadTwoR() {
		ProcessorTestTemplate(new String[] {
				...
				"00000000000000000000000000000000",
				// Instruction [type=MATH, operation=NOP, registers=NoR[], immediate=0]
				"00000000000000000000000000000000", "00000000000000000000000000000111" }, processor -> {
	...
	public void BasicLoadThreeR() {
		ProcessorTestTemplate(new String[] {
				...
				"00000000000000000000000000000000",
				// Instruction [type=MATH, operation=NOP, registers=NoR[], immediate=0]
				"00000000000000000000000000000000", "00000000000000000000000000010111"
	...
	public void BasicStoreDestOnly() {
		ProcessorTestTemplate(new String[] {
				...
				"00000000010000000001101011010101", }, processor -> {
	...
	public void BasicStoreThreeR() {
		ProcessorTestTemplate(new String[] {
				...
				"00000000001001000001101110110110", }, processor -> {
	...
	public void BasicBranchZeroR() {
		ProcessorTestTemplate(new String[] {
				...
				// Instruction [type=MATH, operation=NOP,
				// registers=DestOnly[Rd=Register[number=1]], immediate=1]
				"00000000000000000101100000100001", }, processor -> {
	...
	public void BasicBranchDestOnly() {
		ProcessorTestTemplate(new String[] {
				...
				// Rd=Register[number=1]], immediate=0]
				"00000000000000001111100000100011", }, processor -> {
	...
	public void BasicCallZeroR() {
		ProcessorTestTemplate(new String[] {
				...
				"00000000000000000000000000010000", }, processor -> {
	...
	public void BasicCallDestOnly() {
		ProcessorTestTemplate(new String[] {
				...
				// Instruction [type=MATH, operation=ADD, registers=TwoR[Rs1=Register[number=1],
				// Rd=Register[number=1]], immediate=0]
				"00000000000000000111100000100011", }, processor -> {
	...
	public void BasicPushPop1() {
		ProcessorTestTemplate(new String[] {
				...
				// Rd=Register[number=6]], immediate=0]
				"00000000000000001101100011011011", }, processor -> {
	...
	public void BasicPushPop2() {
		ProcessorTestTemplate(new String[] {
				...
				"00000000000000000001100011111001", }, processor -> {
	...
	public void BasicBranchThreeR() {
		ProcessorTestTemplate(new String[] {
				...
				"00000000000000010101100010000001", }, processor -> {
	...
	public void IterativeFactorial() {
		ProcessorTestTemplate(new String[] {
				...
				// registers=DestOnly[Rd=Register[number=1]], immediate=5]
				"00000000000000010101100000100001",
				// Instruction [type=CALL, operation=NOP, registers=NoR[], immediate=6]
				"00000000000000000000000011001000",
				// Instruction [type=MATH, operation=ADD,
				// registers=ThreeR[Rs1=Register[number=3], Rs2=Register[number=0],
				// Rd=Register[number=5]], immediate=0]
				"00000000000110000011100010100010",
				// Instruction [type=MATH, operation=NOP,
				// registers=DestOnly[Rd=Register[number=1]], immediate=7]
				"00000000000000011101100000100001",
				// Instruction [type=CALL, operation=NOP, registers=NoR[], immediate=6]
				...
				// registers=DestOnly[Rd=Register[number=4]], immediate=1]
				"00000000000000000101100010000001",
				// Instruction [type=BRANCH, operation=NE,
				// registers=TwoR[Rs1=Register[number=1], Rd=Register[number=2]], immediate=2]
				"00000000000100000100010001000111",
				// Instruction [type=MATH, operation=NOP,
				// registers=DestOnly[Rd=Register[number=3]], immediate=1]
				"00000000000000000101100001100001",
				// Instruction [type=LOAD, operation=NOP, registers=NoR[], immediate=0]
				...
				// Instruction [type=CALL, operation=NOP, registers=NoR[], immediate=8]
				"00000000000000000000000100001000",
				// Instruction [type=MATH, operation=ADD,
				// registers=ThreeR[Rs1=Register[number=1], Rs2=Register[number=4],
				// Rd=Register[number=1]], immediate=0]
				"00000000000010010011100000100010",
				// Instruction [type=MATH, operation=MUL, registers=TwoR[Rs1=Register[number=1],
				// Rd=Register[number=3]], immediate=0]
				"00000000000000000101110001100011",
				// Instruction [type=LOAD, operation=NOP, registers=NoR[], immediate=0]
				"00000000000000000000000000010000", }, proccesor -> {
					assertEquals(120, proccesor.getRegister(5).getSigned());
					assertEquals(5040, proccesor.getRegister(3).getSigned());
				});
	...
	public void RecursiveFactorial() {
		ProcessorTestTemplate(new String[] {
				...
				// Instruction [type=MATH, operation=NOP,
				// registers=DestOnly[Rd=Register[number=1]], immediate=8]
				"00000000000000100001100000100001",
				// Instruction [type=CALL, operation=NOP, registers=NoR[], immediate=3]
				"00000000000000000000000001101000",
				// Instruction [type=MATH, operation=NOP, registers=NoR[], immediate=0]
				"00000000000000000000000000000000",
				...
				// registers=DestOnly[Rd=Register[number=2]], immediate=1]
				"00000000000000000101100001000001",
				// Instruction [type=BRANCH, operation=LT,
				// registers=TwoR[Rs1=Register[number=2], Rd=Register[number=1]], immediate=2]
				"00000000000100001000100000100111",
				// Instruction [type=MATH, operation=NOP,
				// registers=DestOnly[Rd=Register[number=3]], immediate=1]
				"00000000000000000101100001100001",
				// Instruction [type=LOAD, operation=NOP, registers=NoR[], immediate=0]
				"00000000000000000000000000010000",
				// Instruction [type=PUSH, operation=SUB,
				...
				// Instruction [type=CALL, operation=NOP, registers=NoR[], immediate=4]
