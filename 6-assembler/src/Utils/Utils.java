...
public final class Utils {
	...
	private static final Bit[] TRUE_BITS = new Bit[] { getTrue(), getTrue(), getTrue(), getTrue(), getTrue(), getTrue(),
	...
	private static final Bit[] FALSE_BITS = new Bit[] { getFalse(), getFalse(), getFalse(), getFalse(), getFalse(),
			getFalse(), getFalse(), getFalse(), getFalse(), getFalse(), getFalse(), getFalse(), getFalse(), getFalse(),
			getFalse(), getFalse(), getFalse(), getFalse(), getFalse(), getFalse(), getFalse(), getFalse(), getFalse(),
